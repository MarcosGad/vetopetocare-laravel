        ...
        <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    @enderror 
                        ...
                        <div class="form-group">
                            <input id="birth"  placeholder="تاريخ الميلاد" type="text" pattern="\d{4}-\d{2}-\d{2}" class="form-control birth form-input @error('birth') is-invalid @enderror" name="birth" value="{{ old('birth') }}" readonly autocomplete="birth" autofocus>
                        ...
                        <div class="form-group">
                            <input id="phone" placeholder="رقم المحمول" type="text" class="form-control form-input @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" autocomplete="phone" autofocus>
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <input id="password" placeholder="كلمة السر" type="password" class="form-input form-control @error('password') is-invalid @enderror" name="password" required autocomplete="password">
